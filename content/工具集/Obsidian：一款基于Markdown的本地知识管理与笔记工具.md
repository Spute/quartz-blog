...
6. <strong>多端支持</strong>：支持 windows、安卓、iOS 等客户端，你可以选择 OneDrive、iCloud、Git 等方式同步资料，也可便携存储于 U 盘。

## 技巧
- 多端自动同步：使用 git 实现自动同步
- 
