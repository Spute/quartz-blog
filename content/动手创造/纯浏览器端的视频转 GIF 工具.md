...
![[BUoYbjNOnoYmNXxTtnHcgVrNnDh.gif]]
...
![[DwZWbfvcooK7uIxEDVwcOiM4nXd.png]]
...
![[IbwubwBBOoP2LdxOGBwcqVH8n4b.png]]

## 微信公众号 gif 图片限制

GIF 图片大小得不能超过 10M，并且长*宽*帧数最好也不要超过 600 万像素，不然会提示“图片的高度、宽度或帧数过高,上传失败,请压缩后重试”。
